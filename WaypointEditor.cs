...
public class WaypointEditor 
{
    ...
    //draw gizmo regardless of whether or not gameobject is selected, pickable means gizmo can be selected

    [DrawGizmo(GizmoType.NonSelected | GizmoType.Selected | GizmoType.Pickable)]
    public static void OnDrawSceneGizmo(Waypoint waypoint, GizmoType gizmoType)
    {
        //change colour on select (or 50% transparent deselected)
        ...
        //draw perimeter line to display waypoint area
        ...
        //draw line between previous and next waypoints
